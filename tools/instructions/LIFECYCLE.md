...
- **Membership is still yours**: which items the snapshot carries, and their `note:` prose, are curation the script leaves alone. `goal:` is derived from the note (ADR-0018); edit it there.
