...
tasks: [TASK-0090, TASK-0091, TASK-0092, TASK-0093, TASK-0094, TASK-0095, TASK-0096, TASK-0097, TASK-0098, TASK-0099, TASK-0100, TASK-0101, TASK-0102, TASK-0103, TASK-0104, TASK-0105, TASK-0106, TASK-0107, TASK-0108, TASK-0109, TASK-0156, TASK-0157, TASK-0158, TASK-0159, TASK-0160, TASK-0080, TASK-0081, TASK-0163, TASK-0164, TASK-0165, TASK-0166, TASK-0167, TASK-0161]
issues: [ISS-0003, ISS-0041, ISS-0042, ISS-0043, ISS-0044, ISS-0045, ISS-0046, ISS-0047, ISS-0048, ISS-0084, ISS-0049, ISS-0050, ISS-0051, ISS-0052, ISS-0053, ISS-0054, ISS-0055, ISS-0056, ISS-0057, ISS-0058, ISS-0061]
...
- [x] REQ-0026 and REQ-0027 are implemented, every criterion ticked with evidence — evidence, 2026-09-25: both notes are `implemented` with every criterion ticked; REQ-0027's first criterion was met by the drift sweeps recorded on it. The text that follows is this box's state on 2026-09-03, when REQ-0027 stayed `approved`: its first criterion is not met, the drift sweep at the close of the phase found 36 restatements (ISS-0048), and its third is owed with that issue
...
- [x] FEAT-0021 is done: TASK-0081's lookup query exists, and the feature's independent review is recorded — evidence: `snapshot-query.py`; FEAT-0021 `## Review`, round 1 changes-requested, round 2 approved, 2026-09-25; TST-0024 23 of 23; 20,225 snapshot fields match PyYAML across the fleet
- [x] ISS-0053 is fixed: a misspelt frontmatter key is reported, and the cockpit's validator has been checked for the same hole (TASK-0163) — evidence: FRONTMATTER-TYPO, 0 fleet findings, `elated:` caught; the cockpit's validator reports the repro; TST-0025 10 of 10
- [x] ISS-0052 is fixed: index, enforced-field and citation checks each measured over the fleet and tested (TASK-0164 to TASK-0166), and the drift dimension re-measured (TASK-0167) — evidence: INDEX-COVERAGE, FIELD-UNDOCUMENTED and CITATION, each measured and mutation-checked (TST-0025); the re-measurement is on ADR-0026
...
Every exit criterion is ticked with its evidence and every note naming this phase is resolved. The last session, on Edwin's instruction to complete and test the phase in full: TASK-0081 closed FEAT-0021 after a two-round review; ISS-0053 and ISS-0052 are fixed with four validator checks, each measured over the fleet and mutation-tested (TST-0025); the drift dimension was re-measured (ADR-0026). Left with Edwin: whether to narrow the drift dimension's brief, as that re-measurement recommends.
