...
Rules for the lifecycle of work. Each is stated once here, with a reason and a link (project-os-dev REQ-0026).
...
- A new external dependency or version constraint; a new required env var or configuration surface; a directory layout or artifact path change; a runtime increase or new long-running step; a security, credential or licence exposure. If none applies, say so in the note or the summary; the negative result is part of the scan.
