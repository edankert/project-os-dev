...
| [[PHASE-0004-The-Walk\|PHASE-0004]] | The walk: a procedure over the owed checks | `planned` | A generated walk sheet over the owed acceptance checks: the changed surfaces first, then sittings in an order authored once per project in WALK.md, each check's setup, steps and expected result inline. FEAT-0029, REQ-0028, ADR-0029, TASK-0110–TASK-0115. Rendered by project-os-cockpit (its FEAT-0149), consumed first by your-trainer (its FEAT-0119) |
| [[PHASE-0005-The-Walk-Reads-As-A-Script\|PHASE-0005]] | The walk reads as a script | `planned` | The walk sheet opens with the app screens a release changed (a rider-facing sentence from each change note, before and after captures, no test ids), then one LLM-written procedure per sitting that a validator holds to the owed set. Surfaces become screens by default. FEAT-0030, FEAT-0031, REQ-0029, ADR-0044 and ADR-0045 (both proposed), TASK-0116–TASK-0123. Rendered by project-os-cockpit (its PHASE-044, FEAT-0150), consumed first by your-trainer (its PHASE-024, FEAT-0120, FEAT-0121) |
