---
name: issue-intake
description: "project-os issue intake playbook. Use when: A prompt reports a bug, mismatch, broken workflow, unclear documentation, or unexpected behavior; An agent or a review finds a defect it will not fix now. **First apply the filing bar** in ../../instructions/QUALITY.md (\"The filing bar\"): a defect in code the current feature changed is fixed in that feature, not filed"
---
