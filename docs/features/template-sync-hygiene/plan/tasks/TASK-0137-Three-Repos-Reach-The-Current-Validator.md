...
## Definition of Done
- [ ] edankert.com (40 PARENT-BACKLINK and 7 SNAPSHOT-MEMBERSHIP errors), your-applications.com (50 and 13) and yourtrainer-mcp (6 SNAPSHOT-MEMBERSHIP and 10 VERIFY) validate with the template's current validator.
- [ ] Stale manual tests (VERIFY) are walked again or given a dated waiver. Either is Edwin's call and is asked, not assumed.
- [ ] Each repo takes the template's `validate-docs.py`.
