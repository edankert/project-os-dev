...
- Prefer repo-relative paths in code spans (e.g. `../../docs/INDEX.md`, `../scripts/validate-docs.sh`). `validate-docs.sh` resolves each one (CITATION), so a cited path must exist.
